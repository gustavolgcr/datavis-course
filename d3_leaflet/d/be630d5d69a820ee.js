...
hourDimension.group()
  ...
  main.variable(observer()).define(["hourGroup"], function(hourGroup){return(
hourGroup.top(2)
)});
  main.variable(observer("buildvis2")).define("buildvis2", ["md","container","dc","dateDimension","d3"], function(md,container,dc,dateDimension,d3)
{
  let view = md`${container('chart','Earthquakes')}`
  let chart = dc.dataTable(view.querySelector("#dc-table-graph"))
  ...
  main.variable(observer("buildvis3")).define("buildvis3", ["md","container","dc","d3","magnitudeDimension","magnitudeGroup"], function(md,container,dc,d3,magnitudeDimension,magnitudeGroup)
{
  let view = md`${container('chart2','Valores')}`
  ...
  main.variable(observer("buildvis4")).define("buildvis4", ["md","container","dc","d3","depthDimension","depthGroup"], function(md,container,dc,d3,depthDimension,depthGroup)
{
  let view = md`${container('chart3','Valores')}`
  ...
  main.variable(observer("buildvis5")).define("buildvis5", ["md","container","dc","d3","dataset","hourDimension","hourGroup"], function(md,container,dc,d3,dataset,hourDimension,hourGroup)
{
  let view = md`${container('chart4','Valores')}`
  ...
  main.variable(observer("map")).define("map", ["buildvis5","L"], function(buildvis5,L)
{
buildvis5;
  ...
  main.variable(observer("circles")).define("circles", ["circlesLayer","dataset","L"], function(circlesLayer,dataset,L)
{
  circlesLayer.clearLayers()
    ...
    circle.bindPopup(`<strong>Magnitude</strong>: ${d.magnitude} </br> <strong>Time</strong>: ${d.dtg}`)
